...
function draw(){
    ...
    textSize(15);
    text("To drag the first ball with the mouse, press 1.",10,height-81);
    text("To drag the second ball with the mouse, press 2.",10,height-64);
    text("To drag the third ball with the mouse, press 3.",10,height-47);
    text("To drag the fourth ball with the mouse, press 4.",10,height-30);
    text("To drag the fifth ball with the mouse, press 5.",10,height-13)
